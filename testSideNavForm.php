...
<div class="row">
	<div class="col-2" >
		<div class="sticky-top"> <!-- IMPORTANT CLASS TO GET THE NAV ON SCROLLING -->
		<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			<a class="nav-link active" id="v-pills-home-tab"  href="#cc0" role="tab" aria-controls="v-pills-home" aria-selected="true">Cheif complaints</a>
			<a class="nav-link" id="v-pills-profile-tab"  href="#appetite" role="tab" aria-controls="v-pills-profile" aria-selected="false">Appetite</a>
