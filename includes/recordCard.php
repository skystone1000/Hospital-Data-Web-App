<?php
	...
	<div class="list-group-item list-group-item-action flex-column align-items-start active">
		<div class="d-flex justify-content-between row">
			<h5 class="mb-1 col-6">' . $row['regno'] . " : " . $row['firstName'] . " " . $row['middleName'] . " " . $row['lastName']  . '</h5>
			<div class="col"><a href="followUp.php?id=' . $row['id'] . '" target="_blank"><button class="btn btn-warning my-2 my-sm-0" type="submit" value="submit">FollowUp</button></a></div>
